...
<div class="sidebar">
		<div class="logo2 clear"><img src="images/logo.jpg" alt="" width="185" height="200" /></div>
                    <div class="waktu">
...
while($s = mysql_fetch_array($soal)){
    ...
    echo "<tr><td><img src='foto_soal_pilganda/$s[gambar]'></td></tr>";    
...
while($e=  mysql_fetch_array($soal_esay)){
    ...
    echo "<tr><td><img src='foto_soal/$e[gambar]'></td></tr>";
