...
<title>E-Learning System Nicesoftmedia</title>
...
<body onload="startclock()">
	...
	<div class="sidebar">
		<div class="logo clear"><img src="images/logo.jpg" alt="" width="185" height="200" /></div>

		<div class="menu">
		  <ul><li><a href="#">MENU SISWA</a>
			  <ul>
				  <?php include "menu.php"; ?>
			  </ul>
			</li>
			  <li><a href="#">DATA AKUN</a>
			    <ul>
...
var h = d.getHours();
if (h < 11) { document.write('Selamat Pagi Penerus Bangsa'); }
else { if (h < 15) { document.write('Selamat Siang Penerus Bangsa'); }
else { if (h < 19) { document.write('Selamat Sore Penerus Bangsa'); }
else { if (h <= 23) { document.write('Selamat Malam Penerus Bangsa'); }
}}}</SCRIPT>    </ul> </div></li>
